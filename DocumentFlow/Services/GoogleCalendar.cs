...
namespace DocumentFlow.Services
{
    public class GoogleCalendar
    {
            ...
            try
            {
                ...
                if (calendarService != null && string.IsNullOrWhiteSpace(serviceError))
                {
                    ...
                    if (calendar != null)
                    {
                        ...
                        {
                            new Google.Apis.Calendar.v3.Data.EventAttendee() { Email = "3565733@gmail.com" },
        ...
        public static void Run()
        {
            ...
            calendarEventId = AddCalenderEvents(refreshToken, "3565733@gmail.com", "My Calendar Event", DateTime.Now, DateTime.Now.AddHours(12), out addEventError);

            string updateEventError;
            if (!string.IsNullOrEmpty(calendarEventId))
            {
                UpdateCalenderEvents(refreshToken, "3565733@gmail.com", "Modified Calendar Event ", DateTime.Now, DateTime.Now.AddDays(1), calendarEventId, out updateEventError);
            }

            string deleteEventError;
            if (!string.IsNullOrEmpty(calendarEventId))
            {
                DeletCalendarEvents(refreshToken, "3565733@gmail.com", calendarEventId, out deleteEventError);
            }
        }
    }
}
